      ...
      <div style={{borderBottom:`1px solid ${C.border}`,paddingBottom:0}}>
        ...
        <div style={{display:"flex",alignItems:"center",padding:"10px 16px 6px",gap:16}}>
          ...
          <button onClick={()=>giveMwah(post.id)} style={{background:"none",border:"none",cursor:"pointer",padding:0,display:"flex",alignItems:"center",gap:5}}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill={post.myMwah?C.flame:"none"} stroke={post.myMwah?C.flame:C.bark} strokeWidth="2" strokeLinecap="round"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
          </button>
          {/* Comment */}
          ...
          {!isMe&&<button onClick={()=>handleSavePost(post.id)} style={{marginLeft:"auto",background:"none",border:"none",cursor:"pointer",padding:0}}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill={isSaved?C.bark:"none"} stroke={C.bark} strokeWidth="2" strokeLinecap="round"><path d="M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2z"/></svg>
          </button>}
        </div>
